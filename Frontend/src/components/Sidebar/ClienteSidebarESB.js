...
export default function ClienteSidebarESB() {
            ...
            <ul className="md:flex-col md:min-w-full flex flex-col list-none">
              ...
              <li className="items-center">
                <Link
                  ...
                  to="/cliente_esb/solicitudes"
                >
                  <i
                    className={
                      "fas fa-book mr-2 text-sm " +
                      (window.location.href.indexOf("/cliente/solicitudes") !== -1
                        ? "opacity-75"
                        : "text-blueGray-300")
                    }
                  ></i>{" "}
